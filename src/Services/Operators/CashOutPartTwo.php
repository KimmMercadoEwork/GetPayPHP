...
use DateTime;
use GetPayPHP\Services\CacheGlobals as Cache;
...
class CashOutPartTwo
{
    ...
    {
        $this->incrementCashOutPartOneAttempt();
        ...
        if (
            $this->isCashOutPartOneFreeWeek($basis)
            && $this->stillInMinimumCashOutPartOne()
        ) {
     ...
     * @return string|float
     */
    protected function getCashOutPartOneAttempts()
    {
        $key = sprintf('%s-CashOutPartOne-attempts', $this->generateTagKey());
     ...
     * @return bool
     */
    protected function incrementCashOutPartOneAttempt()
    {
        $key = sprintf(
            '%s-CashOutPartOne-attempts',
     ...
     * @return bool
     */
    protected function stillInMinimumCashOutPartOne()
    {
        if ($this->getCashOutPartOneAttempts() <= static::NATURAL_FREE_MAX_CASHOUT) {
            return true;
        }
     ...
     * @return bool
     */
    protected function isCashOutPartOneFreeWeek($basis)
    {
